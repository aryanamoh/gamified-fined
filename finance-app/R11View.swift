            ...
            VStack {
                ...
                ZStack {
                    ...
                    VStack {
                        ...
                        Text("setting aside a portion of your income helps to achieve future needs, goals, and gives safety for unforeseen expenses. but at the cost of having less things you want now. are you happy with your decision?")
                            .monospaced()
                            .multilineTextAlignment(/*@START_MENU_TOKEN@*/.leading/*@END_MENU_TOKEN@*/)
                            .padding([.horizontal], 30)
                    }
